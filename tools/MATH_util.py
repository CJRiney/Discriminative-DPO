...
class MATHReasoning():
    ...
    def normalize(self, string):
        ...
        new_string = self.fix_sqrt(new_string)
        new_string = self.fix_fracs(new_string)
        new_string = self.strip_string(new_string)
        new_string = self.fix_a_slash_b(new_string)
        new_string = self.remove_right_units(new_string)
