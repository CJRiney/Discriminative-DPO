...
dir = Path(f'./stats/{model}_stats')
dir.mkdir(parents=True, exist_ok=True)
results_path = f"./stats/{model}_stats/{model}_accuracy_mc.json"
responses_path = f"./stats/{model}_stats/{model}_responses_mc.json"
bool_array_path = f"./stats/{model}_stats/{model}_correct_mc.json"
